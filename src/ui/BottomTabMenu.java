...
public class BottomTabMenu extends Menu {
	...
	public static Sprite defaultSpr = new Sprite ("resources/ui/sample_bottom_tab_default.png");
	public static Sprite selectedSpr = new Sprite ("resources/ui/sample_bottom_tab_select.png");
	...
	public BottomTabMenu (GUI handler, String id) {
		...
		//Add menu components
		buttons[0] = new SelectableMenuTab (null, defaultSpr, selectedSpr, selectedSpr, this, id + "0");
		buttons[1] = new SelectableMenuTab (null, defaultSpr, selectedSpr, selectedSpr, this, id + "1");
		buttons[2] = new SelectableMenuTab (null, defaultSpr, selectedSpr, selectedSpr, this, id + "2");
